...
{
public:
    Ordinaryuser(string a,string b,string c):User(a,b,c)
    {}
    void addPosts(int i);
...
{
    public:
        Administrator(string a,string b,string c):User(a,b,c)
         {}
};
...
{
public:
    Moderator(string a,string b,string c):Ordinaryuser(a,b,c)
      {}
